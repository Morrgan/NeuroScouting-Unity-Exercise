...
public class TenTrials : MonoBehaviour {
    ...
    int[] secondaryLocation = new int[11];
    ...
    void Start () {
        ...
        // choose 6 random sets to have the target object
        for (int j = 0; j < 6; j++)
        {
            ...
            else if (r + 3 < secondaryLocation.Length && secondaryLocation[r + 3] == 0)
            {
                secondaryLocation[r + 3] = 1;
            }
            else if (r + 4 < secondaryLocation.Length && secondaryLocation[r + 4] == 0)
            {
                secondaryLocation[r + 4] = 1;
            }
            else if (r + 5 < secondaryLocation.Length && secondaryLocation[r + 5] == 0)
            {
                secondaryLocation[r + 5] = 1;
            }
        }
    }
